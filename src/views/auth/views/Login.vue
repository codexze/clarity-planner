  ...
  <div class="min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md space-y-8 px-2">
      <div class="text-center">
        ...
        <p class="mt-6 text-center text-xl tracking-tight text-gray-900">Sign in to your account</p>
      </div>
      ...
      <form class="space-y-6" @submit.prevent>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" v-model="form.rememberMe" class="h-4 w-4 rounded border-gray-300 text-blue-500 accent-blue-600 focus:ring-blue-500" />
            <label for="remember-me" class="ml-2 block text-sm text-gray-900">Remember me</label>
          </div>
          <div class="text-sm">
            <router-link to="/auth/forgot-password" class="font-semibold text-blue-500 hover:text-blue-600">Forgot password?</router-link>
          </div>
        </div>

        <div>
          <button @click="onLogin" class="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 border border-transparent rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-md hover:shadow-lg transition-all duration-200">Sign in</button>
        </div>
      </form>
    </div>
  </div>
